@echo off
:: ============================================================================
:: run_all.bat  —  TB_CPA_Extraction v1.2  Daily launcher
:: ============================================================================
::
:: HOW TO SCHEDULE WITH WINDOWS TASK SCHEDULER:
:: 1. Open  Task Scheduler  (search in Start menu)
:: 2. Click  "Create Basic Task..."
:: 3. Name:    TB_CPA_Extraction_daily
:: 4. Trigger: Daily  →  set your desired start time (e.g. 06:00)
:: 5. Action:  "Start a program"
::             Program/script:   C:\...\TB_CPA_Extraction_v1.2\run_all.bat
::             Start in (optional but recommended):
::                               C:\...\TB_CPA_Extraction_v1.2\
...
:: - Output is appended to run_all.log in the same folder.
...
echo. >> "%LOG_FILE%"
echo ============================================================ >> "%LOG_FILE%"
echo [%DATE% %TIME%] TB_CPA Extraction pipeline started >> "%LOG_FILE%"
echo ============================================================ >> "%LOG_FILE%"
